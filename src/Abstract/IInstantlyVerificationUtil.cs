...
public interface IInstantlyVerificationUtil
{
    ...
    /// <returns></returns>
    ValueTask<InstantlyVerificationResponse?> Verify(string email, string webhookUri, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ValueTask<InstantlyVerificationResponse?> GetResult(string email, CancellationToken cancellationToken = default);
}